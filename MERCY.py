...
async def on_message(message_in):
    ...
    if message_in.server.id == "266279338305912832":
        ...
        if "307400427954110465" in list(role.id
            ...
            rgb = colorsys.hsv_to_rgb(random.randint(90, 150)/360, random.uniform(0.20,1),random.uniform(0.20,1))
...
async def output_channel_embed(server, channel_name_or_id):
    ...
    embed = discord.Embed(title="{channelname}  info".format(channelname=name)
                                + ' ' * 180 + "​​​​​​")
